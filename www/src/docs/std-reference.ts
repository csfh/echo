...
export const stdModules: StdModule[] = [
  {
    ...
    name: "io",
    title: "I/O",
    summary: "Print strings to stdout, log, and stderr; read stdin as bytes.",
    group: "Core",
    ...
    exports: [
      ...
      {
        name: "read",
        role: "Read all of standard input as bytes",
        call: "io.read()",
        description:
  ...
  },
  {
    ...
    name: "bytes",
    title: "Bytes",
    summary: "Byte sequences: length, slice, concat, conversions, and search.",
    group: "Core",
    ...
    exports: [
      ...
      {
        name: "contains",
        role: "Whether haystack contains a byte subsequence",
        call: "bytes.contains(hay, needle)",
        description:
          "Reports whether hay contains needle as a contiguous subsequence. An empty needle is true.",
        params: "hay: bytes to search. needle: bytes subsequence.",
        returns: "Boolean.",
        example: "/ std/bytes\n\n$ ok = bytes.contains(b'hello', b'ell')",
      },
      {
        name: "starts_with",
        role: "Whether bytes start with a prefix",
        call: "bytes.starts_with(b, prefix)",
        description: "Reports whether b starts with prefix. An empty prefix is true.",
        params: "b: bytes. prefix: expected leading bytes.",
        returns: "Boolean.",
        example: "/ std/bytes\n\n$ ok = bytes.starts_with(b'foobar', b'foo')",
      },
      {
        name: "ends_with",
        role: "Whether bytes end with a suffix",
        call: "bytes.ends_with(b, suffix)",
        description: "Reports whether b ends with suffix. An empty suffix is true.",
        params: "b: bytes. suffix: expected trailing bytes.",
        returns: "Boolean.",
        example: "/ std/bytes\n\n$ ok = bytes.ends_with(b'foobar', b'bar')",
      },
    ],
  },
  {
    ...
    name: "list",
    title: "Lists",
    summary: "List helpers: length, access, sum, sort, and map/filter/fold.",
    group: "Core",
    ...
    exports: [
      ...
      {
        name: "map",
        role: "Transform each element through a function value",
        call: "list.map(xs, f)",
        description:
      ...
      {
        name: "filter",
        role: "Keep elements for which a predicate is true",
        call: "list.filter(xs, pred)",
        description:
          "Returns a new list of elements for which pred is true. pred must be a closed function value that returns a boolean.",
        params: "xs: list. pred: function of one argument, boolean result.",
        returns: "New list of matching elements.",
        example:
          "/ std/list\n\n$ even = (n) {\n    ^ n % 2 == 0\n}\n$ ys = list.filter([1, 2, 3, 4], even)",
      },
      {
        name: "fold",
        role: "Left-fold a list with an accumulator",
        call: "list.fold(xs, acc0, f)",
        description:
          "Folds xs from the left: acc starts as acc0, then acc = f(acc, element) for each element. f must be a closed function value.",
        params: "xs: list. acc0: initial accumulator. f: function of (accumulator, element).",
        returns: "Final accumulator (acc0 when xs is empty).",
        example:
          "/ std/list\n\n$ add = (a, b) {\n    ^ a + b\n}\n$ n = list.fold([1, 2, 3], 0, add)",
      },
    ],
  },
  {
    ...
    exports: [
      ...
      },
      {
        ...
        call: "time.mono_ms()",
        description:
          "Monotonic milliseconds since process start (process-wide, not wall clock). Useful for measuring intervals.",
        params: "No parameters.",
  ...
  },
  {
    ...
    exports: [
      ...
      },
      {
        ...
        description: "Creates a symbolic link at `link` pointing to `original`.",
        params: "original: target path. link: new symlink path.",
        returns: "None on success.",
        example: '/ std/fs\n\nfs.symlink("/tmp/a", "/tmp/link")',
      },
      {
        name: "chmod",
  ...
  {
    path: "std/encoding/utf8",
    name: "utf8",
    title: "UTF-8",
    summary: "Strict UTF-8 validation and decode (not lossy str.from_bytes).",
    group: "Data",
    docsPath: "/docs/std/encoding-utf8",
    exports: [
      {
        name: "valid",
        role: "Whether bytes are well-formed UTF-8",
        call: "utf8.valid(b)",
        description:
          "Reports whether b is well-formed UTF-8. Strings are always valid. Invalid sequences are false.",
  ...
  },
  {
    ...
    exports: [
      ...
      },
      {
        ...
        description:
          "Unpacks the first entry from a zip archive. On success the product has name (string) and data (bytes).",
  ...
  },
  {
    ...
    exports: [
      ...
      {
        name: "from_indexed",
        role: "Build a map from a list of values",
        call: "map.from_indexed(ls)",
        description:
          "Builds a map with integer keys 0, 1, 2, … for each list element (not a list of key/value pairs).",
        params: "ls: list of values.",
        returns: "Map value.",
        example: "/ std/collections/map\n\n$ m = map.from_indexed([10, 20, 30])",
      },
    ],
  },
  {
    ...
    exports: [
      {
        ...
        example:
          '/ std/crypto/aes_gcm\n\n| aes_gcm.encrypt(b"0123456789abcdef0123456789abcdef", b"0123456789ab", b"hi") {\n    $ c { }\n    ! e { }\n}',
      },
      {
        name: "decrypt",
